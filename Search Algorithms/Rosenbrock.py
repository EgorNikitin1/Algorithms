...
while True:
    ...
    if sqrt((xt[0] - xp[0]) ** 2 + (xt[1] - xp[1]) ** 2) > err:
        ...
        _lambda = (diff[1]*d[1][0]-diff[0]*d[1][1]) / (d[0][1]*d[1][0]-d[0][0]*d[1][1]), (diff[1]*d[0][0]-diff[0]*d[0][1]) / (d[0][0]*d[1][1]-d[0][1]*d[1][0])
        a = (_lambda[0] * d[0][0] + _lambda[1] * d[1][0], _lambda[0] * d[0][1] + _lambda[1] * d[1][1]), (_lambda[1] * d[1][0], _lambda[1] * d[1][1])
